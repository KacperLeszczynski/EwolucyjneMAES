...
\providecommand{\numofalgs}{1}
\providecommand{\algname}{bbob results-0001{}}
\providecommand{\algfolder}{bbob_results-0001_060420h3345/}
...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.7.3}}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{bbob results{}}
\providecommand{\algfolder}{bbob_results_060420h0003/}
\providecommand{\bbobecdfcaptionallgroups}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
